      ...
      <div className="flex">
        ...
        <div className="flex-1 relative">
          <div className="h-64 bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-500 relative">
            ...
            {/* Avatar positioned absolutely over the banner - extending outside */}
          ...
          <div className="px-8 pt-16 pb-8">
            ...
            <div className="flex gap-8">
              {/* Left Side - About Me and Auctions */}
              <div className="flex-1 max-w-2xl">
                ...
                <div>
                  ...
                  <div className="relative bg-slate-900 rounded-xl p-6 border border-slate-800 max-w-md">
                    <div className="relative">
                      <img src="https://wallpaperaccess.com/full/190730.jpg" alt="Auction Art" className="w-full h-96 object-cover rounded-lg mb-4" />
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    <div className="w-10 h-10 rounded-full overflow-hidden flex-shrink-0">
                      <img src="https://media.gq.com.mx/photos/5f6ce732bc946e88f6c96320/16:9/w_2560%2Cc_limit/goky%2520ultra%2520instinto.jpg" alt="User Avatar" className="w-full h-full object-contain bg-slate-700" />
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="relative">
                        <img src="https://wallpaperaccess.com/full/190721.jpg" alt="Art Post" className="w-full h-48 object-cover rounded-lg" />
